...
function raiseError(form, name, error) {
  ...
  } else if (element.classList.contains('govuk-input')) {
    element.closest('.govuk-input__wrapper').parentNode.insertBefore(errorMessage, element.closest('.govuk-input__wrapper'))
  } else {
